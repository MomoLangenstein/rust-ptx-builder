...
//! <https://github.com/rust-analyzer/rust-analyzer/blob/d598d0b4f1aba67453287bf1a8e19cf7f47fd2d5/crates/stdx/src/process.rs>
...
pub fn streaming_output<O: FnMut(&str), E: FnMut(&str)>(
    cmd: &mut Command,
...
mod imp {
    ...
    pub(crate) fn read2(
        ...
        while num_fds > 0 {
            ...
            let r = unsafe { libc::poll(fds.as_mut_ptr(), num_fds, -1) };
            if r == -1 {
